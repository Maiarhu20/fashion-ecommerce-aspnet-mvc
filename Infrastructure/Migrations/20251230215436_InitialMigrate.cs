    ...
    public partial class InitialMigrate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShippingCities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingCityId = table.Column<int>(type: "int", nullable: true),
                    ShippingCityName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    TotalAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    Subtotal = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    OriginalTotal = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ShippingCost = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    DiscountAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    DiscountCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_ShippingCities_ShippingCityId",
                        column: x => x.ShippingCityId,
                        principalTable: "ShippingCities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductDiscountPercent = table.Column<decimal>(type: "decimal(5,2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorHexCode = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderPaymentKey = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    Amount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    PaymentMethod = table.Column<int>(type: "int", nullable: false),
                    Currency = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    AppliedDiscountCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    DiscountAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountUsages_DiscountId_SessionId",
                table: "DiscountUsages",
                columns: new[] { "DiscountId", "SessionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DiscountUsages_GuestEmail",
                table: "DiscountUsages",
                column: "GuestEmail");

            migrationBuilder.CreateIndex(
                name: "IX_DiscountUsages_SessionId",
                table: "DiscountUsages",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_HomeMedias_CreatedAt",
                table: "HomeMedias",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_HomeMedias_DisplayOrder",
                table: "HomeMedias",
                column: "DisplayOrder");

            migrationBuilder.CreateIndex(
                name: "IX_HomeMedias_IsActive",
                table: "HomeMedias",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_HomeMedias_IsActive_DisplayOrder",
                table: "HomeMedias",
                columns: new[] { "IsActive", "DisplayOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_HomeMedias_MediaType",
                table: "HomeMedias",
                column: "MediaType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingCities_CityName",
                table: "ShippingCities",
                column: "CityName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ShippingCities_IsActive",
                table: "ShippingCities",
                column: "IsActive");
        }
